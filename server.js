...
app.post("/feedback", (request, response) => {
    ...
    // NLP Logic
    // Conversion from contractions to standard lexicons
    const lexedData = aposToLexForm(request.body.feedback);
    console.log("Lexed Data: ",lexedData);

    // Convert all data to lowercase
    const casedData = convertTolowerCase(lexedData);
    console.log("LowerCase Format: ",casedData);

    // Remove non alphabets and special characters
    const onlyAlpha = removeNonAlpha(casedData);
    ...
    const analysis = analyzer.getSentiment(filteredData);
